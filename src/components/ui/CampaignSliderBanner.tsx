    ...
    >
      <div className="flex flex-row w-full border border-gray-400 rounded-lg">
        <img
          ...
          alt="campaign"
          draggable={false}
          className="w-[375px] h-[292px] object-cover hidden xl:block rounded-l-lg select-none"
        />

        <div className="flex flex-col p-4 w-full h-[292px]">
