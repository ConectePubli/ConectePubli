  ...
  return (
    <div className="w-full p-4 md:p-8">
      ...
      <div className="max-w-4xl mx-auto mt-8 grid grid-cols-1 xl:grid-cols-2 gap-6 max-xl:mt-0 md:w-[80%]">
        <div
          className={`relative bg-white shadow ${currentPlan && !currentPlan.cancel_at ? "h-[785px]" : "h-[740px]"} rounded-md flex flex-col justify-between border-2 border-[#FF7A49] translate-y-[45px] order-2 xl:order-1 max-xl:translate-y-0 py-6 
          ${currentPlan && !currentPlan.cancel_at ? "max-lg:h-[685px]" : "max-lg:h-[640px]"}`}
        >
        ...
        <div
          className={`relative bg-white shadow ${currentPlan && !currentPlan.cancel_at ? "h-[830px]" : "h-[785px]"} rounded-md flex flex-col justify-between border-2 border-[#FF7A49] order-1 xl:order-2 max-xl:mt-[50px] max-lg:h-[685px]`}
        >
