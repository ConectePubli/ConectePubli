...
function TermosDeUso() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 text-gray-800">
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2">
        1. Termos de Veiculação:
      </h3>
      <p className="mb-4">
        Ao aceitar a presente campanha publicitária, o(a) Creator concorda que,
        no caso de tráfego pago, a utilização de seu conteúdo seguirá
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2">
        2. Alterações nas Condições:
      </h3>
      <p className="mb-4">
        Quaisquer alterações nos locais de veiculação ou extensão do período
        previamente acordado deverão ser negociadas e formalizadas mediante nova
        autorização e compensação financeira adicional, conforme acordado entre
        as partes.
      </p>

      <h3 className="text-lg font-semibold mt-4 mb-2">
        3. Remuneração e Direitos:
      </h3>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          condições especificadas, respeitando os direitos autorais e de imagem
          do(a) Creator.
        </li>
      </ul>

      <h3 className="text-lg font-semibold mt-4 mb-2">5. Penalidades:</h3>
      <p className="mb-4">
        O descumprimento de qualquer uma das condições estabelecidas nesta
        cláusula poderá acarretar sanções legais, incluindo indenização por uso
        indevido da imagem do(a) Creator.
      </p>
    </div>
  );
}
